...
<html lang="pt-br" dir="ltr">
  ...
  <body>
    <!-- HEADER/NAVEGACAO -->
    <?php
    include "./parte_header.php";

    $id_anuncio = $_GET['id_anuncio'];
    $anuncios = mysqli_query($bd, "SELECT * FROM anuncios WHERE id_anuncio = $id_anuncio");
    while($anuncio = mysqli_fetch_array($anuncios))
    {
      $titulo = $anuncio['anuncio'];
      $ilustracao = $anuncio['ilustracao'];
    ...
    <div>
      <form class="anunciar-form" action="../services/editar_anuncio.php?id_anuncio=<?php echo $id_anuncio;?>" method="post" enctype="multipart/form-data">
        <label class="anunciar-form-titulo" for="titulo">Título</label>
        <input required type="text" id="titulo" name="anuncio" value="<?php echo $titulo;?>">
        ...
        <textarea required id="descricao" name="descricao" maxlength="199" value="<?php echo $descricao;?>" placeholder="Infome o máximo de informações."></textarea>
